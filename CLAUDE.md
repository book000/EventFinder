...
- **言語**: Java 8 (`java.version` = 1.8)
- **ビルドツール**: Maven
- **フレームワーク**: PaperMC 1.16.5 API (`com.destroystokyo.paper:paper-api:1.16.5-R0.1-SNAPSHOT`)
- **主要ライブラリ**:
...
- Reflections ライブラリはクラスパススキャンを行うため、パフォーマンスに注意する
